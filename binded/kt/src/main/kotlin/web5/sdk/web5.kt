...
internal interface UniffiLib : Library {
    ...
    fun uniffi_web5_fn_func_jwk_compute_thumbprint(`jwk`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_web5_checksum_func_jwk_compute_thumbprint(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_web5_checksum_func_jwk_compute_thumbprint() != 59133.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
public object FfiConverterOptionalString: FfiConverterRustBuffer<kotlin.String?> {
    ...
    @Throws(JwkException::class) fun `jwkComputeThumbprint`(`jwk`: Jwk): kotlin.String {
            return FfiConverterString.lift(
    uniffiRustCallWithError(JwkException) { _status ->
    UniffiLib.INSTANCE.uniffi_web5_fn_func_jwk_compute_thumbprint(
