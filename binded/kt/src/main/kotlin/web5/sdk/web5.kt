...
internal interface UniffiLib : Library {
    ...
    fun uniffi_web5_fn_constructor_jwk_new(`alg`: RustBuffer.ByValue,`kty`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    ...
    fun uniffi_web5_fn_func_hello_world(uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_web5_fn_func_new_jwk(`alg`: RustBuffer.ByValue,`kty`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    ...
    fun uniffi_web5_checksum_func_new_jwk(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_web5_checksum_func_hello_world() != 45094.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_checksum_func_new_jwk() != 11721.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_web5_checksum_constructor_jwk_new() != 8948.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
open class Jwk: Disposable, AutoCloseable, JwkInterface {
    ...
    constructor(`alg`: kotlin.String, `kty`: kotlin.String) :
        this(
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_web5_fn_constructor_jwk_new(
        FfiConverterString.lower(`alg`),FfiConverterString.lower(`kty`),_status)
}
    )
...
public object FfiConverterTypeJwkError : FfiConverterRustBuffer<JwkException> {
    ...
    override fun write(value: JwkException, buf: ByteBuffer) {
        ...
        = 
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_web5_fn_func_hello_world(
        _status)
}
    
    
 fun `newJwk`(`alg`: kotlin.String, `kty`: kotlin.String): Jwk {
            return FfiConverterTypeJwk.lift(
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_web5_fn_func_new_jwk(
        FfiConverterString.lower(`alg`),FfiConverterString.lower(`kty`),_status)
}
    )
    }
