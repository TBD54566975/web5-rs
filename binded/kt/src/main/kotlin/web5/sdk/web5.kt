...
internal interface UniffiLib : Library {
    ...
    fun uniffi_web5_uniffi_fn_clone_uniffijwkerror(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_web5_uniffi_fn_free_uniffijwkerror(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_web5_uniffi_fn_method_uniffijwkerror_message(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_web5_uniffi_fn_clone_uniffiweb5error(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_web5_uniffi_fn_free_uniffiweb5error(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_web5_uniffi_fn_method_uniffiweb5error_error_type(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_web5_uniffi_fn_method_uniffiweb5error_error_variant(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_web5_uniffi_fn_method_uniffiweb5error_message(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_web5_uniffi_fn_func_test_err(uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_web5_uniffi_fn_func_test_jwk_err(uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_web5_uniffi_fn_func_test_key_manager_err(uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    ...
    fun uniffi_web5_uniffi_checksum_func_test_err(
    ): Short
    fun uniffi_web5_uniffi_checksum_func_test_jwk_err(
    ): Short
    fun uniffi_web5_uniffi_checksum_func_test_key_manager_err(
    ): Short
    fun uniffi_web5_uniffi_checksum_method_uniffijwkerror_message(
    ): Short
    fun uniffi_web5_uniffi_checksum_method_uniffiweb5error_error_type(
    ): Short
    fun uniffi_web5_uniffi_checksum_method_uniffiweb5error_error_variant(
    ): Short
    fun uniffi_web5_uniffi_checksum_method_uniffiweb5error_message(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_web5_uniffi_checksum_func_test_err() != 55004.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_uniffi_checksum_func_test_jwk_err() != 1446.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_uniffi_checksum_func_test_key_manager_err() != 52185.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_uniffi_checksum_method_uniffijwkerror_message() != 56807.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_uniffi_checksum_method_uniffiweb5error_error_type() != 18828.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_uniffi_checksum_method_uniffiweb5error_error_variant() != 16520.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_uniffi_checksum_method_uniffiweb5error_message() != 65454.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
public interface UniFfiJwkExceptionInterface {
...
open class UniFfiJwkException : Exception, Disposable, AutoCloseable, UniFfiJwkExceptionInterface {
        ...
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_free_uniffijwkerror(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_clone_uniffijwkerror(pointer!!, status)
        }
    }
    ...
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_method_uniffijwkerror_message(
        it, _status)
}
    }
    )
    ...
    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<UniFfiJwkException> {
        override fun lift(error_buf: RustBuffer.ByValue): UniFfiJwkException {
            // Due to some mismatches in the ffi converter mechanisms, errors are a RustBuffer.
            val bb = error_buf.asByteBuffer()
            if (bb == null) {
                throw InternalException("?")
            }
            return FfiConverterTypeUniFfiJwkError.read(bb)
        }
    }
    
}

public object FfiConverterTypeUniFfiJwkError: FfiConverter<UniFfiJwkException, Pointer> {

    override fun lower(value: UniFfiJwkException): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): UniFfiJwkException {
        return UniFfiJwkException(value)
    }

    override fun read(buf: ByteBuffer): UniFfiJwkException {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: UniFfiJwkException) = 8UL

    override fun write(value: UniFfiJwkException, buf: ByteBuffer) {
...
public interface UniffiWeb5ExceptionInterface {
...
open class UniffiWeb5Exception : Exception, Disposable, AutoCloseable, UniffiWeb5ExceptionInterface {
    ...
    private class UniffiCleanAction(private val pointer: Pointer?) : Runnable {
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_free_uniffiweb5error(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_clone_uniffiweb5error(pointer!!, status)
        }
    }
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_method_uniffiweb5error_error_type(
        it, _status)
}
    }
    )
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_method_uniffiweb5error_error_variant(
        it, _status)
}
    }
    )
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_method_uniffiweb5error_message(
        it, _status)
}
    }
    )
    ...
    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<UniffiWeb5Exception> {
        override fun lift(error_buf: RustBuffer.ByValue): UniffiWeb5Exception {
            // Due to some mismatches in the ffi converter mechanisms, errors are a RustBuffer.
            val bb = error_buf.asByteBuffer()
            if (bb == null) {
                throw InternalException("?")
            }
            return FfiConverterTypeUniffiWeb5Error.read(bb)
        }
    }
    
}

public object FfiConverterTypeUniffiWeb5Error: FfiConverter<UniffiWeb5Exception, Pointer> {

    override fun lower(value: UniffiWeb5Exception): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): UniffiWeb5Exception {
        return UniffiWeb5Exception(value)
    }

    override fun read(buf: ByteBuffer): UniffiWeb5Exception {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: UniffiWeb5Exception) = 8UL

    override fun write(value: UniffiWeb5Exception, buf: ByteBuffer) {
        // The Rust code always expects pointers written as 8 bytes,
        // and will fail to compile if they don't fit.
        buf.putLong(Pointer.nativeValue(lower(value)))
    }
...
public object FfiConverterOptionalString: FfiConverterRustBuffer<kotlin.String?> {
    ...
    @Throws(UniFfiJwkException::class) fun `testErr`()
        = 
    uniffiRustCallWithError(UniFfiJwkException) { _status ->
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_func_test_err(
        _status)
}
    
    

    @Throws(UniffiWeb5Exception::class) fun `testJwkErr`()
        = 
    uniffiRustCallWithError(UniffiWeb5Exception) { _status ->
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_func_test_jwk_err(
        _status)
}
    
    

    @Throws(UniffiWeb5Exception::class) fun `testKeyManagerErr`()
        = 
    uniffiRustCallWithError(UniffiWeb5Exception) { _status ->
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_func_test_key_manager_err(
        _status)
}
