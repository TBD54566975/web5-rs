...
use super::{
    ...
    data_model_validation::validate_vc_data_model,
    issuer::Issuer,
    jose_kit::{JoseVerifier, JoseVerifierAlwaysTrue},
...
pub fn vc_from_vc_jwt(vc_jwt: &str, verify: bool) -> Result<VerifiableCredential> {
        ...
        match exp {
            ...
            Some(exp) => {
                if vc_payload_expiration_date
                    ...
                    .map_err(|e| Web5Error::Unknown(format!("unknown system time error {}", e)))?
                    .as_secs()
                    != exp
                        .duration_since(UNIX_EPOCH)
                        .map_err(|e| {
...
mod tests {
    ...
    mod from_vc_jwt {
        ...
        fn test_missing_kid_jose_header() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_without_kid, true);
        ...
        fn test_empty_kid_jose_header() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_empty_kid, true);
        ...
        fn test_kid_invalid_did_uri() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_invalid_did_uri, true);
        ...
        fn test_kid_fail_to_resolve_did() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_invalid_did_resolution, true);
        ...
        fn test_kid_missing_verification_method() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_missing_vm, true);
        ...
        fn test_fails_cryptographic_verification() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_invalid_signature, true);
        ...
        fn test_passes_cryptographic_verification() {
            ...
            let vc = vc_from_vc_jwt(vc_jwt_valid, true).expect("vc_jwt should be valid");
            assert_eq!(
        ...
        fn test_can_skip_cryptographic_verification() {
            ...
            let vc = vc_from_vc_jwt(vc_jwt_with_invalid_signature, false)
        ...
        fn test_can_skip_data_model_validation() {
            ...
            let vc = vc_from_vc_jwt(vc_jwt_with_expired, false).expect("vc_jwt should be valid");
        ...
        fn test_issuer_string() {
            ...
            let vc = vc_from_vc_jwt(&vc_jwt_with_issuer_as_string, false)
        ...
        fn test_issuer_object() {
            ...
            let vc =
                vc_from_vc_jwt(&vc_jwt_with_issuer_object, false).expect("should be valid vc jwt");
            match vc.issuer {
        ...
        fn test_missing_vc_claim() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_missing_vc_claim, true);
        ...
        fn test_missing_jti_claim() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_missing_jti_claim, true);
        ...
        fn test_missing_issuer_claim() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_missing_iss_claim, true);
        ...
        fn test_missing_subject_claim() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_missing_sub_claim, true);
        ...
        fn test_missing_nbf_claim() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_missing_nbf_claim, true);
        ...
        fn test_claim_mismatch_id() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_mismatch_id, true);
        ...
        fn test_claim_mismatch_issuer() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_mismatch_issuer, true);
        ...
        fn test_claim_mismatch_subject() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_mismatch_subject, true);
        ...
        fn test_claim_misconfigured_exp() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_misconfigured_exp, true);
        ...
        fn test_claim_mismatch_exp() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_mismatch_exp, true);
        ...
        fn test_validate_dm_empty_id() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_empty_id, true);
        ...
        fn test_validate_dm_empty_context() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_empty_context, true);
        ...
        fn test_validate_dm_context_base_mismatch() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_without_base_context, true);
        ...
        fn test_validate_dm_empty_type() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_empty_type, true);
        ...
        fn test_validate_dm_type_base_mismatch() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_without_base_type, true);
        ...
        fn test_validate_dm_empty_issuer() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_empty_issuer, true);
        ...
        fn test_validate_dm_empty_subject() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_empty_subject, true);
        ...
        fn test_validate_dm_issuance_in_future() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_issuance_date_in_future, true);
        ...
        fn test_validate_dm_credential_expired() {
            ...
            let result = vc_from_vc_jwt(vc_jwt_with_expired, true);
