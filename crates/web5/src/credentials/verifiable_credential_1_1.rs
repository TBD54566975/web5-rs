...
impl VerifiableCredential {
    ...
    pub async fn create(
        ...
        super::create::create_vc(issuer, credential_subject, options).await
    }
    ...
    /// ```
    pub async fn from_vc_jwt(vc_jwt: &str, verify: bool) -> Result<Self> {
        let verifiable_credential = decode(vc_jwt, verify).await?;
...
mod tests {
    ...
    mod from_vc_jwt {
        ...
        #[tokio::test]
        async fn test_missing_kid_jose_header() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_without_kid, true).await;

            assert_credential_error(result, VerificationError::MissingKid);
        }

        #[tokio::test]
        async fn test_empty_kid_jose_header() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_empty_kid, true).await;
        ...
        #[tokio::test]
        async fn test_kid_invalid_did_uri() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_invalid_did_uri, true).await;
        ...
        #[tokio::test]
        async fn test_kid_fail_to_resolve_did() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_invalid_did_resolution, true).await;
        ...
        #[tokio::test]
        async fn test_kid_missing_verification_method() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_missing_vm, true).await;
        ...
        #[tokio::test]
        async fn test_fails_cryptographic_verification() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_invalid_signature, true).await;
        ...
        #[tokio::test]
        async fn test_passes_cryptographic_verification() {
        ...
        #[tokio::test]
        async fn test_can_skip_cryptographic_verification() {
        ...
        #[tokio::test]
        async fn test_can_skip_data_model_validation() {
        ...
        #[tokio::test]
        async fn test_can_skip_credential_schema_validation() {
            // expired would throw an error, but since verify=false it doesn't
        ...
        #[tokio::test]
        async fn test_decode_issuer_string() {
        ...
        #[tokio::test]
        async fn test_decode_issuer_object() {
        ...
        #[tokio::test]
        async fn test_decode_credential_schema() {
        ...
        #[tokio::test]
        async fn test_decode_missing_vc_claim() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_missing_vc_claim, true).await;
            assert_credential_error(result, VerificationError::MissingClaim("vc".to_string()));
        }

        #[tokio::test]
        async fn test_decode_missing_jti_claim() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_missing_jti_claim, true).await;
            assert_credential_error(result, VerificationError::MissingClaim("jti".to_string()));
        }

        #[tokio::test]
        async fn test_decode_missing_issuer_claim() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_missing_iss_claim, true).await;
        ...
        #[tokio::test]
        async fn test_decode_missing_subject_claim() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_missing_sub_claim, true).await;
        ...
        #[tokio::test]
        async fn test_decode_missing_nbf_claim() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_missing_nbf_claim, true).await;
        ...
        #[tokio::test]
        async fn test_decode_claim_mismatch_id() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_mismatch_id, true).await;
        ...
        #[tokio::test]
        async fn test_decode_claim_mismatch_issuer() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_mismatch_issuer, true).await;
        ...
        #[tokio::test]
        async fn test_decode_claim_mismatch_subject() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_mismatch_subject, true).await;
        ...
        #[tokio::test]
        async fn test_decode_claim_misconfigured_exp() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_misconfigured_exp, true).await;
        ...
        #[tokio::test]
        async fn test_decode_claim_mismatch_exp() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_mismatch_exp, true).await;
        ...
        #[tokio::test]
        async fn test_validate_dm_empty_id() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_empty_id, true).await;
        ...
        #[tokio::test]
        async fn test_validate_dm_empty_context() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_empty_context, true).await;
        ...
        #[tokio::test]
        async fn test_validate_dm_context_base_mismatch() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_without_base_context, true).await;
        ...
        #[tokio::test]
        async fn test_validate_dm_empty_type() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_empty_type, true).await;
        ...
        #[tokio::test]
        async fn test_validate_dm_type_base_mismatch() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_without_base_type, true).await;
        ...
        #[tokio::test]
        async fn test_validate_dm_empty_issuer() {
            ...
            let vc = decode(vc_jwt_with_empty_issuer, true).await.unwrap();
        ...
        #[tokio::test]
        async fn test_validate_dm_empty_subject() {
            ...
            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_empty_subject, true).await;
        ...
        #[tokio::test]
        async fn test_validate_dm_issuance_in_future() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_issuance_date_in_future, true).await;
        ...
        #[tokio::test]
        async fn test_validate_dm_credential_expired() {
            let vc_jwt_with_expired = r#"eyJ0eXAiOiJKV1QiLCJhbGciOiJFZERTQSIsImtpZCI6ImRpZDpqd2s6ZXlKaGJHY2lPaUpGWkRJMU5URTVJaXdpYTNSNUlqb2lUMHRRSWl3aVkzSjJJam9pUldReU5UVXhPU0lzSW5naU9pSnpjV3hxVTJaZlgzbE9TVVpKTVVwaWNYQkVSVEJuVUZGT2FVazBiVkZqV2pONmRtZFVVbmg2WTAxbkluMCMwIn0..pP_8QVzTqxuhUlIWpXDWQ3Py_VlDA4uX82xdD9GOdmRT2UK-K5Gn7A5qdUxBPhXifiRVnH_Q8NbWZCUQ8jZUBg"#;

            let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_expired, true).await;
        ...
        async fn test_schema_type_must_be_jsonschema() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_with_wrong_schema_type, true).await;
        ...
        async fn test_schema_fails_validation() {
            ...
            let result =
                VerifiableCredential::from_vc_jwt(vc_jwt_at_port_with_invalid_schema, true).await;
            match result {
                Err(Web5Error::JsonSchema(err_msg)) => {
        ...
        async fn test_schema_example_from_spec() {
            ...
            let _ = VerifiableCredential::from_vc_jwt(vc_jwt_at_port, true)
                .await
                .unwrap();
        }
    }
