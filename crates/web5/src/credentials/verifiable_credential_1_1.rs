...
mod tests {
    ...
    use crate::{dids::resolution::resolution_metadata::ResolutionMetadataError, test_helpers::UnitTestSuite, test_name};
    ...
    fn test_kid_fail_to_resolve_did() {
        ...
        let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_invalid_did_resolution, true);
    ...
    fn test_passes_cryptographic_verification() {
        ...
        let vc = VerifiableCredential::from_vc_jwt(vc_jwt_valid, true).expect("vc_jwt should be valid");
        assert_eq!(
    ...
    fn test_can_skip_cryptographic_verification() {
        ...
        let vc = VerifiableCredential::from_vc_jwt(vc_jwt_with_invalid_signature, false).expect("vc_jwt should be valid");
    ...
    fn test_can_skip_data_model_validation() {
        ...
        let vc = VerifiableCredential::from_vc_jwt(vc_jwt_with_expired, false).expect("vc_jwt should be valid");
    ...
    fn test_issuer_string() {
        ...
        let vc = VerifiableCredential::from_vc_jwt(&vc_jwt_with_issuer_as_string, false).expect("should be valid vc jwt");
        match vc.issuer {
    ...
    fn test_issuer_object() {
        ...
        let vc = VerifiableCredential::from_vc_jwt(&vc_jwt_with_issuer_object, false).expect("should be valid vc jwt");
        match vc.issuer {
    ...
    fn test_validate_dm_issuance_in_future() {
        ...
        let result = VerifiableCredential::from_vc_jwt(vc_jwt_with_issuance_date_in_future, true);
