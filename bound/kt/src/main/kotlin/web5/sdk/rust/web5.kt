...
internal interface UniffiCallbackInterfaceExampleForeignTraitMethod2 : com.sun.jna.Callback {
    fun callback(`uniffiHandle`: Long,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,)
}
...
@Structure.FieldOrder("helloWorld", "helloWorld2", "helloWorld3", "uniffiFree")
internal open class UniffiVTableCallbackInterfaceExampleForeignTrait(
    ...
    @JvmField internal var `helloWorld3`: UniffiCallbackInterfaceExampleForeignTraitMethod2? = null,
    ...
    class UniffiByValue(
        ...
        `helloWorld3`: UniffiCallbackInterfaceExampleForeignTraitMethod2? = null,
        `uniffiFree`: UniffiCallbackInterfaceFree? = null,
    ): UniffiVTableCallbackInterfaceExampleForeignTrait(`helloWorld`,`helloWorld2`,`helloWorld3`,`uniffiFree`,), Structure.ByValue
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            ...
            lib.also {                uniffiCheckContractApiVersion(lib)
                ...
                uniffiCallbackInterfaceExampleForeignTrait.register(lib)
                }
        }
    ...
    fun uniffi_web5_uniffi_fn_clone_exampleforeigntrait(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Pointer
    fun uniffi_web5_uniffi_fn_free_exampleforeigntrait(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    fun uniffi_web5_uniffi_fn_init_callback_vtable_exampleforeigntrait(`vtable`: UniffiVTableCallbackInterfaceExampleForeignTrait,
    ): Unit
    ...
    fun uniffi_web5_uniffi_fn_method_exampleforeigntrait_hello_world_3(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    ...
    fun uniffi_web5_uniffi_fn_func_example_foreign_trait(`ex`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
    ): Unit
    ...
    fun uniffi_web5_uniffi_checksum_func_example_foreign_trait(
    ): Short
    ...
    fun uniffi_web5_uniffi_checksum_method_exampleforeigntrait_hello_world_3(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_web5_uniffi_checksum_func_example_foreign_trait() != 9674.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_uniffi_checksum_method_bearerdid_get_data() != 23985.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_web5_uniffi_checksum_method_bearerdid_get_signer() != 29753.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_web5_uniffi_checksum_method_document_find_public_key_jwk() != 23655.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_web5_uniffi_checksum_method_exampleforeigntrait_hello_world_3() != 27624.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_web5_uniffi_checksum_method_inmemorykeymanager_import_private_jwk() != 46931.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_web5_uniffi_checksum_constructor_bearerdid_new() != 50602.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface ExampleForeignTrait {
...
open class ExampleForeignTraitImpl: Disposable, AutoCloseable, ExampleForeignTrait {
    ...
    private class UniffiCleanAction(private val pointer: Pointer?) : Runnable {
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_free_exampleforeigntrait(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_clone_exampleforeigntrait(pointer!!, status)
        }
    }
    ...
    @Throws(RustCoreErrorV2::class)override fun `helloWorld3`()
        = 
    callWithPointer {
    uniffiRustCallWithError(RustCoreErrorV2) { _status ->
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_method_exampleforeigntrait_hello_world_3(
        it, _status)
}
    }
...
internal object uniffiCallbackInterfaceExampleForeignTrait {
    internal object `helloWorld`: UniffiCallbackInterfaceExampleForeignTraitMethod0 {
        override fun callback(`uniffiHandle`: Long,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,) {
            val uniffiObj = FfiConverterTypeExampleForeignTrait.handleMap.get(uniffiHandle)
            val makeCall = { ->
                uniffiObj.`helloWorld`(
                )
            }
    ...
    internal object `helloWorld3`: UniffiCallbackInterfaceExampleForeignTraitMethod2 {
        override fun callback(`uniffiHandle`: Long,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,) {
            val uniffiObj = FfiConverterTypeExampleForeignTrait.handleMap.get(uniffiHandle)
            val makeCall = { ->
                uniffiObj.`helloWorld3`(
                )
            }
            val writeReturn = { _: Unit -> Unit }
            uniffiTraitInterfaceCallWithError(
                ...
                makeCall,
                writeReturn,
                { e: RustCoreErrorV2 -> FfiConverterTypeRustCoreErrorV2.lower(e) }
            )
        }
    }
    ...
    internal object uniffiFree: UniffiCallbackInterfaceFree {
        override fun callback(handle: Long) {
            FfiConverterTypeExampleForeignTrait.handleMap.remove(handle)
        }
    }
    ...
    internal fun register(lib: UniffiLib) {
        lib.uniffi_web5_uniffi_fn_init_callback_vtable_exampleforeigntrait(vtable)
    }
}

public object FfiConverterTypeExampleForeignTrait: FfiConverter<ExampleForeignTrait, Pointer> {
    internal val handleMap = UniffiHandleMap<ExampleForeignTrait>()

    override fun lower(value: ExampleForeignTrait): Pointer {
        return Pointer(handleMap.insert(value))
    }

    override fun lift(value: Pointer): ExampleForeignTrait {
        return ExampleForeignTraitImpl(value)
    }

    override fun read(buf: ByteBuffer): ExampleForeignTrait {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: ExampleForeignTrait) = 8UL

    override fun write(value: ExampleForeignTrait, buf: ByteBuffer) {
        // The Rust code always expects pointers written as 8 bytes,
        // and will fail to compile if they don't fit.
        buf.putLong(Pointer.nativeValue(lower(value)))
    }
...
sealed class RustCoreErrorV2: Exception() {
    ...
    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<RustCoreErrorV2> {
        override fun lift(error_buf: RustBuffer.ByValue): RustCoreErrorV2 = FfiConverterTypeRustCoreErrorV2.lift(error_buf)
    }

    
}

public object FfiConverterTypeRustCoreErrorV2 : FfiConverterRustBuffer<RustCoreErrorV2> {
    override fun read(buf: ByteBuffer): RustCoreErrorV2 {
        

        return when(buf.getInt()) {
            1 -> RustCoreErrorV2.Exception(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
    ...
    override fun allocationSize(value: RustCoreErrorV2): ULong {
        return when(value) {
            is RustCoreErrorV2.Exception -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`type`)
    ...
    override fun write(value: RustCoreErrorV2, buf: ByteBuffer) {
        when(value) {
            is RustCoreErrorV2.Exception -> {
                buf.putInt(1)
                FfiConverterString.write(value.`type`, buf)
...
public object FfiConverterMapStringString: FfiConverterRustBuffer<Map<kotlin.String, kotlin.String>> {
 ...
 fun `exampleForeignTrait`(`ex`: ExampleForeignTrait)
        = 
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_web5_uniffi_fn_func_example_foreign_trait(
        FfiConverterTypeExampleForeignTrait.lower(`ex`),_status)
}
