...
const WasmKeyManagerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmkeymanager_free(ptr >>> 0));
/**
*/
class WasmKeyManager {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmKeyManagerFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmkeymanager_free(ptr);
    }
    /**
    */
    constructor() {
        const ret = wasm.wasmkeymanager_new();
    ...
    */
    generate_private_key(curve) {
        ...
        try {
            ...
            wasm.wasmkeymanager_generate_private_key(retptr, this.__wbg_ptr, ptr0, len0);
...
module.exports.WasmKeyManager = WasmKeyManager;
